...
console.log(user)
const userProfile = {username: req.body.username, email: req.body.email, password: hashBrowns};
...
// }
// console.log(req.body);
return UserModel.findAll({where:{email: req.body.email}}).then((users) => {
